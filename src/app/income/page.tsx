    ...
    <div className='container mx-auto px-4 py-4 md:py-8 space-y-6'>
      ...
      <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
        <div>
          ...
          <p className='text-gray-600 mt-1'>
            Track your income sources and cashflow
          </p>
        </div>
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-2xl md:text-3xl font-bold mt-1'>
                {formatAmount(
                  totalReceived,
                  getCurrencyByCode(settings.currency)
                )}
              </p>
      ...
      {filteredIncomes.length === 0 ? (
        <div className='text-center py-12'>
          ...
          <p className='text-gray-600 mb-4'>
            Start tracking your income to get insights into your cashflow
          </p>
          <button
            onClick={addIncomeModal.openModal}
                  ...
                  <div className='flex-1'>
                    ...
                    <div className='flex flex-wrap items-center gap-4 text-sm text-gray-600'>
                      <span className='flex items-center gap-1 font-semibold text-green-700'>
                        ...
                        {formatAmount(
                          income.amount,
                          getCurrencyByCode(income.currency)
                        )}
      ...
      <ResponsiveModal
        ...
        <IncomeForm
          ...
          onCancel={addIncomeModal.closeModal}
        />
      </ResponsiveModal>
