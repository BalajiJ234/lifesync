...
const expenseTypes = [
  { value: 'recurring', name: 'Recurring Payment', icon: '🔄', description: 'Subscriptions, bills, etc.' },
  { value: 'essential', name: 'Monthly Essential', icon: '🏠', description: 'Groceries, utilities, etc.' },
  { value: 'one-time', name: 'One-Time Purchase', icon: '🛍️', description: 'Regular shopping, entertainment, etc.' },
  { value: 'luxury', name: 'Luxury / Optional', icon: '💎', description: 'Premium items, treats, etc.' },
  { value: 'emergency', name: 'Emergency Expense', icon: '🚨', description: 'Unexpected urgent costs' },
]
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          {formData.description && (
            ...
            >
              <Sparkles size={16} />
              <span>{aiLoading ? 'Getting AI Suggestion...' : '✨ Try AI Suggestion'}</span>
            </button>
          )}
        </div>
      </div>
